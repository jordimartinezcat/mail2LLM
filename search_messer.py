"""
Script para buscar empresas con "MESSER" en el nombre.
"""
...
def main():
    ...
    print("\n🔍 Empresas con 'MESSER' en el nombre:")
    print("=" * 80)
    
    found = []
    for id_, nom in cache:
        if 'MESSER' in nom.upper():
    ...
    if found:
        ...
        print("  No se encontraron empresas con 'MESSER' en el nombre")
